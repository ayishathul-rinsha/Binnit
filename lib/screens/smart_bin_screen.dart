...
class _SmartBinScreenState extends State<SmartBinScreen>
  ...
  Widget _buildOverviewCard() {
    final avgFill = _bins.isEmpty ? 0.0 : _bins.fold<double>(0, (sum, bin) => sum + bin['fillLevel']) / _bins.length;
                ...
                child: _binActionButton(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Text('Remote bin unlocking coming soon!'),
              ...
              Expanded(
                child: _binActionButton(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Text('Maintenance reporting coming soon!'),
                        backgroundColor: AppTheme.primaryGreen,
                        behavior: SnackBarBehavior.floating,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                      ),
...
class _WeeklyChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    final fillPath = Path();
    final spacing = data.length > 1 ? size.width / (data.length - 1) : size.width;
